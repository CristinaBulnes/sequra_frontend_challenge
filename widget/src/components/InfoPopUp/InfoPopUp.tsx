...
const infoItems = [
  ...
  {
    description: "El resto de pagos se cargaran automaticamente a tu tarjeta.",
  },
];
...
function InfoPopUp({ handleClose }: InfoPopUpProps) {
  const { instalmentFee } = useContext(CreditAgreementsContext);
